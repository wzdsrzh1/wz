...
class ComputeLoss:
    ...
    def __call__(self, p, targets, img=None, epoch=0, boxgain=7.5, clsgain=0.5, dflgain=1.5):
        ...
        loss[0] *= boxgain  # box gain
        loss[1] *= clsgain  # cls gain
        # loss[2] *= dflgain  # dfl gain
        loss[2] = loss[2] * 0.  # dfl gain
